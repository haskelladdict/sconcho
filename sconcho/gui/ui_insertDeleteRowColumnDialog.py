...
#
# Created: Mon Jan 24 18:23:49 2011
...
class Ui_InsertDeleteRowColumnDialog(object):
    def setupUi(self, InsertDeleteRowColumnDialog):
        InsertDeleteRowColumnDialog.setObjectName("InsertDeleteRowColumnDialog")
        InsertDeleteRowColumnDialog.resize(805, 160)
        InsertDeleteRowColumnDialog.setSizeGripEnabled(True)
        self.verticalLayout = QtGui.QVBoxLayout(InsertDeleteRowColumnDialog)
        ...
        self.deleteRowPivot.setObjectName("deleteRowPivot")
        ...
        self.numDeleteColumns.setObjectName("numDeleteColumns")
        ...
        self.deleteColumnMode.setObjectName("deleteColumnMode")
        self.deleteColumnMode.addItem("")
        self.deleteColumnMode.addItem("")
        ...
        self.deleteColumnPivot.setObjectName("deleteColumnPivot")
        ...
        InsertDeleteRowColumnDialog.setTabOrder(self.insertRowButton, self.numDeleteRows)
        InsertDeleteRowColumnDialog.setTabOrder(self.numDeleteRows, self.deleteRowButton)
        ...
        InsertDeleteRowColumnDialog.setTabOrder(self.insertColumnButton, self.numDeleteColumns)
        InsertDeleteRowColumnDialog.setTabOrder(self.numDeleteColumns, self.deleteColumnButton)
    ...
    def retranslateUi(self, InsertDeleteRowColumnDialog):
        ...
        self.insertRowButton.setText(QtGui.QApplication.translate("InsertDeleteRowColumnDialog", "Insert Row(s)", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.deleteRowMode.setItemText(0, QtGui.QApplication.translate("InsertDeleteRowColumnDialog", "at                          ", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.insertColumnButton.setText(QtGui.QApplication.translate("InsertDeleteRowColumnDialog", "Insert Column(s)", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.deleteColumnMode.setItemText(0, QtGui.QApplication.translate("InsertDeleteRowColumnDialog", "at                                      ", None, QtGui.QApplication.UnicodeUTF8))
